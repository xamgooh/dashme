...
export type PageRow      = { pageUrl: string; clicks: number; impressions: number; ctr: number; position: number }
...
export type SiteWithData = {
  id: string; url: string; displayName: string | null; color: string; lastSynced: string | null
